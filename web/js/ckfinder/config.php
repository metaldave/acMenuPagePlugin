...
function CheckAuthentication()
{
	...
	session_start();
	$authenticated = isset($_SESSION['symfony/user/sfUser/authenticated']) && $_SESSION['symfony/user/sfUser/authenticated'];
	$admin = isset($_SESSION['symfony/user/sfUser/credentials']) && in_array('admin',$_SESSION['symfony/user/sfUser/credentials']);
